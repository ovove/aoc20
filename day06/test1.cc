...
b
    ...
    const auto coll_res{analyze_all_groups_with_any_person_answered_yes(all_forms)};
    const unsigned tot_any_yes_answers = std::transform_reduce(
    ...
    ASSERT_EQ(tot_any_yes_answers, 11U);
}
